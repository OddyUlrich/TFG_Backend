...
public class ExerciseSolutionDTO {
    ...
    public ExerciseSolutionDTO(String name, String statement, List<Tag> tags, Subject subject, String batteryName, User teacher, int numberErrorsSolution, LocalDateTime timestampSolution, StatusExercise statusSolution){
        this.name = name;
